...
The relay server accepts WebSocket audio from remote clients (e.g. [[https://github.com/mwlaboratories/deltaclaw][deltaclaw]] on Even Hub glasses) and returns transcribed words as JSON.
